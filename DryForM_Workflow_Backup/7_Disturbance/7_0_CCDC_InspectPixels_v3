...
//***********************************************************
// DRYFORM - Step 7.0 - CCD Inspect Pixels
//***********************************************************  
...
Adapted from Wiell´s processing chain, GEE Forum

This script has been directly embedded within the TFT-Explorer App (See module 9) but it can be also run here. 

Click on the map to inspect the CCDC results for any single pixel.
For longer time series (i.e. before 2013), additional Landsat imagery should be added.
It would be also possible to fit the harmonics to Sentinel-1 or Sentinel-2 imagery.
...
Map.centerObject(ee.Geometry.Point([-60.1645, -21.755]), 17);
